...
**item.js** - controller에 있는 get함수를 연결
...
**users.js** - controller에 있는 get, post 함수를 연결(이때 넘겨주는 값도 url에 작성해야함)
...
**controllers/index.js** - 요청을 하고 그에 따른 결과나 에러를 클라이언트에 반환한다.
...
**models/index.js** - 요청을 받은 후 DB에 접근하여 작업 수행 후 그에 따른 결과 반환
